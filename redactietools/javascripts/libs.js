    ...
    function bQ(a, c) {
        ...
        for (g = 1; g < i; g++) {
            ...
            if (k === "*") k = l;
                ...
                }!n && !p && d.error("Geen conversie van " + m.replace(" ", " naar ")), n !== !0 && (c = n ? n(c) : p(o(c)))
            }
        }
        return c
    }
    ...
    d.props = {
        ...
        attr: function(a, c, e, f) {
            ...
            if (a.nodeType === 1) {
                ...
                if ((c in a || a[c] !== b) && g && !i) {
                    h && (c === "type" && l.test(a.nodeName) && a.parentNode && d.error("type eigenschap kan niet worden aangepast"), e === null ? a.nodeType === 1 && a.removeAttribute(c) : a[c] = e);
...
// Showdown Markdown Javascript port
...
var imageDialogText="<p style='margin-top: 0px'><b>Voer de URL van de afbeelding in.</b></p><p>Je kunt ook een Title toevoegen, die zal worden weergegeven als een tooltip.</p><p>Voorbeeld:<br />http://wmd-editor.com/images/cloud1.jpg   \"Optionele titel\"</p>";
var linkDialogText="<p style='margin-top: 0px'><b>Voer het webadres in.</b></p><p>Je kunt ook een Title toevoegen, die zal worden weergegeven als een tooltip.</p><p>Voorbeeld:<br />http://wmd-editor.com/   \"Optionele titel\"</p>";
...
boldButton.title="Vetgedrukt <strong> Ctrl+B";
...
italicButton.title="Schuingedrukt <em> Ctrl+I";
...
quoteButton.title="Blokquote <blockquote> Ctrl+Q";
...
codeButton.title="Voorbeeldcode <pre><code> Ctrl+K";
...
imageButton.title="Afbeelding <img> Ctrl+G";
...
olistButton.title="Genummerde lijst <ol> Ctrl+O";
...
ulistButton.title="Ongenummerde lijst <ul> Ctrl+U";
...
headingButton.title="H3 Tussenkop invoegen<h3> Ctrl+H";
...
hrButton.title="Horizontale lineaal <hr> Ctrl+R";
...
undoButton.title="Maak ongedaan - Ctrl+Z";
...
redoButton.title="Opnieuw - Ctrl+Y";
if(/win/.test(nav.platform.toLowerCase())){
redoButton.title="Opnieuw - Ctrl+Y";
}
else{
redoButton.title="Opnieuw - Ctrl+Shift+Z";
}
